	...
	return (
		...
		>
			<div className={clsx(classes.logo, 'flex items-center')}>
				<img className="logo-icon" src="assets/images/logos/logoComunidad.png" alt="logo" />
			</div>
			<h2 className="username text-16 whitespace-no-wrap" color="inherit">
				{user.data.displayName}
			</h2>
			<p className="email text-13 mt-8 opacity-50 whitespace-no-wrap" color="inherit">
				{user.data.email}
			</p>
			{/* {role === 'alumno' || role === 'alumno_secundaria' || role === 'preescolar' || role === 'alumnoe0' || role === 'alumnoe1' || role === 'alumnoe2' || role === 'alumnoe3' || role === 'Alumno-I' || role === 'Alumno-M' || role === 'Alumno-A' ?
				...
				/>
				:
				role == 'maestro' || role == 'Maestro-I' || role == 'Maestro-M' || role == 'Maestro-A' || role == 'maestro_preescolar' || role == 'maestro_secundaria' 
				|| role == 'profesor_summit_2021' || role == 'maestroe1' || role == 'maestroe2' || role == 'maestroe3' ?
