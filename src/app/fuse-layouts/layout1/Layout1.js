...
function Layout1(props) {
	...
	switch (config.scroll) {
		...
		default: {
			return (
				/* role != 'preescolar' &&   role != 'alumno' && role != 'alumno_secundaria' ? */
				role != 'preescolar' && role != 'alumno' && role != 'alumno_secundaria' && role != 'alumnoe0' && role != 'alumnoe1' && role != 'alumnoe2' && role != 'alumnoe3' && role != 'Alumno-I' && role != 'Alumno-M' && role != 'Alumno-A' ?
				<div id="fuse-layout" className={clsx(classes.root, config.mode, `scroll-${config.scroll}`)}>
					{config.leftSidePanel.display && <LeftSideLayout1 />}
