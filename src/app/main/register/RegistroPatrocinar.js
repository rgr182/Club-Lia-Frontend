...
import { registerSponsorship } from './store/registerSlice';
...
function RegistroPatrocinar(props) {
    ...
    useEffect(() => {
        ...
        if (parentRegister.success) {
            ...
            formAux.country = 'México';
            formAux.state = null;
            formAux.sponsorship = null;
            formAux.supportStudents = null;
            formAux.supportAmount = null;
            formAux.supportMonths = null;
    ...
    function handleSubmit(event) {
        ...
        dispatch(registerSponsorship(form, file));
	}
    console.log(form);
                    ...
                    <div className={clsx(classes.root, 'md:pt-160 p-60 lg:px-256')}>
                        ...
                        <div className="flex flex-wrap flex-col w-full">
                            <Typography className={classes.title}>
                                Patrocina un curso completo de Habilidades Digitales y Programación 
                            </Typography>
                        </div>
                        ...
                        >
                            <div className="flex flex-wrap w-full flex-col align-left justify-left py-12 mb-24 md:w-2/3">
                                <Typography className={classes.label}>
                                    ¿Que tipo de patrocinio te gustaría otorgar?
                                </Typography>
                                <SelectFormsy
                                    ...
                                    required
                                    >
                                        <MenuItem className='poppins' value={1}>Proyectos especiales completos desde $600 pesos al mes por alumno</MenuItem>
                                        <MenuItem className='poppins' value={2}>Cursos de programación 100% en Linea</MenuItem>
                                </SelectFormsy >
                            </div>
                             <div className="flex flex-wrap w-full flex-col align-left justify-left py-12 mb-24 md:w-1/3"></div>

                             <div className="flex flex-wrap w-full flex-col align-left justify-left py-12 mb-24 md:w-1/3">
                                 { form.sponsorship == '1' ?
                                    <>
                                        <Typography className={classes.label}>
                                        ...
                                        <SelectFormsy
                                            ...
                                            >
                                                ...
                                                <MenuItem className='poppins' value={11}>Mas de 10</MenuItem>
                                                <MenuItem className='poppins' value={12}>Apoyar con un monto de dinero</MenuItem>
                                        </SelectFormsy >
                                    </>
                                    :
                                    <>
                             ...
                             <div className="flex flex-wrap w-full flex-col align-left justify-left py-12 mb-24 md:w-1/3">
                                 { form.sponsorship == '1' && form.supportStudents != '11' ?
                                    <>
                                        { form.supportStudents == '12' ?
                                            <>
                                                 <Typography className={classes.label}>
                                            ...
                                            <>
                                                <Typography className={classes.label}>
                                                    ¿Cuantos meses te gustaría apoyar?
                                                    </Typography>
                                                    <TextFieldFormsy
                                                    className={classes.textField}
                                                    type="number"
                                    ...
                                    <>
                                        ...
                                        { form.supportStudents == '12' ? 
                                            ...
                                            <>
                                                { form.sponsorship == '1' ?
                                                    <Typography className={classes.label}>
                                                        $ { form.supportStudents && form.supportMonths ? ((form.supportStudents * form.supportMonths) * 600 ): 0} MXN
                                                    </Typography>
                                                    :
                                                    <Typography className={classes.label}>
                                                        $ { form.supportStudents ? (form.supportStudents * 2100 ): 0} MXN
                                                    </Typography>
                                                }
                                            </>
                            ...
                            <div className="w-full sm:w-1 md:w-1/3 py-12 pt-40" style={{padding: '10px'}}>
                            <Typography className={classes.label}>
                            ...
                            <div className="w-full sm:w-1 md:w-1/3 py-12" style={{padding: '10px'}}>
                                <Typography className={classes.label}>
                            ...
                            { form.supportStudents != '11' ?
                                <>
                                    <div className="flex flex-wrap w-full flex-col align-left justify-left py-12 mb-24">
                                        ...
                                        <Typography className={classes.label}>
                                            {/* <Checkbox disabled={form.publish_both} name="publish_logo" value={form.publish_logo}
                                                    onChange={handleChange}></Checkbox>Si
                                            <Checkbox disabled={form.publish_both} name="publish_donors" value={form.publish_donors}
                                                    onChange={handleChange}></Checkbox>Sólo razón social
                                            <Checkbox name="publish_both" value={form.publish_both}
                                                    onChange={handleChange}></Checkbox>Ninguno */}
                                            <RadioGroup
                                                name="publish"
                                                value={form.publish}
                                                onChange={handleChange}
...
export default RegistroPatrocinar;
