...
const EnhancedTable = ({ columns, data, onRowClick }) => {
	...
	return (
		<div className="flex flex-col sm:rounded-16 overflow-hidden" style={{width: '95%'}}>
							...
							<TableRow {...headerGroup.getHeaderGroupProps()}>
								{headerGroup.headers.map(column => (
									<StyledTableCell
										...
										className="tablesTh colorAndPadding text-center-table"
										{...(!column.sortable
									...
									{row.cells.map(cell => {
										return (
											<StyledTableCell
												...
												className={i % 2 === 0 ? 'tablesTdB centerTableHomework' : 'tablesTd centerTableHomework'}
											>
												{cell.render('Cell')}
											</StyledTableCell>
										);
