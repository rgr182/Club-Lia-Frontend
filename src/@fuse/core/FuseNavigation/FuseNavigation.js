...
const useStyles = makeStyles(theme => ({
	navigation: {
		'& .list-item': {
			color: '#353535',
			'&:hover': {
				backgroundColor: theme.palette.type === 'dark' ? 'rgba(250, 255, 255, 0.05)' : 'rgba(0,0,10,.04)'
			},
			'&:focus:not(.active)': {
				backgroundColor: theme.palette.type === 'dark' ? 'rgba(250, 255, 255, 0.06)' : 'rgba(0,0,10,.05)'
			}
		}
	},
	verticalNavigation: {
